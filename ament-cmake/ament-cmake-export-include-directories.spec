...
%global pkgname export-include-directories
%global pkgnameu export_include_directories
...
Summary:	Eport include directories to downstream packages in the ament buildsystem in CMake
BuildArch:	noarch
