...
%global pkgname clang-format
%global pkgnameu clang_format
...
Summary:	clang-format support for ament
BuildArch:	noarch
...
BuildRequires:	ament-copyright
BuildRequires:	ament-pep8
BuildRequires:	ament-pep257
BuildRequires:	ament-pyflakes
Requires:	%{_bindir}/clang-format
